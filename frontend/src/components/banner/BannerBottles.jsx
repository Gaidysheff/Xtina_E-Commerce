        ...
        >
          <div className="w-full">
            <div
              ...
              text-white rounded-3xl p-7 md:p-0
            ...
            >
              ...
              <div data-aos="zoom-in" className="md:mb-0 text-center">
                <p
                  data-aos="fade-up"
                  className="text-3xl md:text-lg lg:text-2xl xl:text-3xl 
                ...
                <p
                  data-aos="zoom-out"
                  className="text-3xl md:text-4xl xl:text-5xl 2xl:text-6xl text-center
              text-white uppercase font-bold my-7 md:my-4 lg:my-7 xl:my-10
                ...
                <p
                  data-aos="fade-up"
                  className="text-2xl sm:text-3xl md:text-lg lg:text-2xl xl:text-3xl 
                  2xl:text-46xl text-center font-['Pacifico']
                  drop-shadow-[10px_10px_6px_rgba(0,0,0,.7)]"
                >
