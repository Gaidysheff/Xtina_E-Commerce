    ...
    <nav className="bg-gray-200 border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          ...
          id="navbar-search"
        >
          <div className="relative mt-3 md:hidden bg-gray-200">
            <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
              <svg
                className="w-4 h-4 text-gray-500 dark:text-gray-400"
                aria-hidden="true"
          ...
          md:flex-row md:mt-0 md:border-0 md:bg-gray-200  
          ...
          >
            <li>
              <NavLink
                ...
                hover:text-white hover:bg-gray-500 hover:rounded-lg
                text-gray-600 md:hover:bg-transparent 
