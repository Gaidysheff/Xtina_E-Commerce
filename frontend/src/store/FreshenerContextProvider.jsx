    ...
    const fetchFresheners = async () => {
      ...
      for (const key in responseData) {
        loadedFresheners.push({
          ...
          top_note1: responseData[key].top_note1,
          top_note2: responseData[key].top_note2,
          top_note3: responseData[key].top_note3,
          top_note4: responseData[key].top_note4,
          top_note5: responseData[key].top_note5,
